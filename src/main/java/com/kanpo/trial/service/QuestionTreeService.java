...
public class QuestionTreeService {
     ...
     * @throws Exception 例外
     */
    public NextQuestion createAnalysis() throws Exception {
        // TOPの質問を取得する
     ...
     * @throws Exception 例外
     */
    public NextQuestion getNextQuestion(SendAnswerRequest request) throws Exception {
     ...
     * @throws Exception 例外
     */
    public NextQuestion getPreQuestion(long analysisId) throws Exception {
     ...
     * @throws Exception 例外
     */
    public List<Medicine> getAnalysisResult(long analysisId) throws Exception {
        // analysisのデータをanalysisIdから参照して情報を取得する
        Optional<Analysis> analysisOpt = analysisRepository.findById(analysisId);
        // analysisIdに対応するanalysisが存在しない場合は例外送出
        if (!analysisOpt.isPresent()) {
     ...
     * @throws Exception 例外
     */
    public void createQuestionTree() throws Exception {
